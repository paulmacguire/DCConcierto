...
<?php include('../templates/header.html'); ?>
    ...
    <?php
        ...
        $query = "SELECT * FROM eventos_propuestos WHERE REPLACE(LOWER(eventos_propuestos.artista), ' ', '_') = '$nombre' AND eventos_propuestos.estado_evento = 'Aceptado';";
...
<?php if (!empty($data)) {?>
  <div class="container text-center">
    <h2> ¡Aquí puedes ver tus eventos aceptados!</h2><br>
